...
" . $fgreen;
        sumber:
            ...
            echo $grey;
            if (empty($c)) {
                echo $merah . "[!] Free cave for this fake option if not used 😠 !!
...
";
                        echo $ciyan . "--[#] " . $grey . "Enter '" . $merah . "X" . $grey . "' to get out
...
";
                        opinfo:
                            ...
                            if (empty($restar)) {
                                echo $merah . "[!] It's hard for me to make an option, I don't even use it, bastard !!
...
" . $grey;
                                ...
                                echo $merah . "[!] 
Optionally there is no choice '" . $orange . $restar . $merah . "' stupid 😠!!
...
";
                    ...
                    sbr:
                        ...
                        if (empty($vis)) {
                            echo $merah . "[!] You choose option 2 but the source is not filled in, it sucks !!
...
" . $grey;
                                            ...
                                            echo $merah . "[!] There is no option '" . $orange . $restar . $merah . "' stupid😠!!
...
";
                            ...
                            echo $merah . "[!] Optionally there is no choice '" . $orange . $c . $merah . "' Stupid 😠!!
